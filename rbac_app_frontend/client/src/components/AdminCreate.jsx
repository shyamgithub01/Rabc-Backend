      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-600 p-6 text-white">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-purple-100">Add administrative users to your system</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full border border-gray-300 rounded-lg py-3 pl-10 pr-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="w-full border border-gray-300 rounded-lg py-3 pl-10 pr-12 text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
          ...
          <button
            ...
            className={`w-full flex justify-center items-center px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-600 text-white rounded-lg font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all shadow-md hover:shadow-lg ${
