  ...
  return (
    <div className="w-full pt-5 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-2 px-4 sm:px-6">
        ...
        >
          <div className="flex items-center">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke={MIDNIGHT_BLUE}>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 极 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
            </div>
            <div className="ml-4">
        ...
        >
          <div className="flex items-center">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke={BLUE_GRAY}>
        ...
        >
          <div className="flex items-center">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke={DARK_BLUE}>
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-800">
                {users.reduce((acc, user) => 
                  acc + (user.modules?.reduce((modAcc, mod) => modAcc + mod.permissions.length, 0) || 0), 
                0)}
              </p>
            </div>
          </div>
      ...
      {isLoading ? (
        ...
        <div 
          className="bg-red-50 border border-red-200 rounded-xl p-6 text-center shadow-sm mx-4 sm:mx-6"
        >
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-6 py-4 border-b border-gray-100">
            <h3 className="font-semibold text-gray-800 mb-4 sm:mb-0">Admin Accounts</h3>
          ...
          <div className="overflow-x-auto ">
            <table className="min-w-full divide-y divide-gray-100 text-sm">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-4 font-medium text-gray-500 text-left uppercase tracking-wider">Admin</th>
                  <th className="px-6 py-4 font-medium text-gray-500 text-left uppercase tracking-wider">Role</th>
                  <th className="px-6 py-4 font-medium text-gray-500 text-left uppercase tracking-wider">Permissions</th>
                  <th className="px-6 py-4 font-medium text-gray-500 text-right uppercase tracking-wider">Actions</th>
                </tr>
              </thead>
                    ...
                    <td colSpan="4" className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center justify-center text-gray-500">
                        <div 
                          ...
                          style={{ background: `linear-gradient(135deg, ${MIDNIGHT_BLUE}10 0%, ${BABY_BLUE}30 100%)` }}
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-blue-500" fill="none" viewBox="0 0 24 24" stroke={MIDNIGHT_BLUE}>
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                        </div>
                        <p className="text-lg font-bold text-gray-700">No admins found</p>
                        <p className="mt-1 text-gray-500">Create your first admin to get started</p>
                        <button
                          onClick={openCreateModal}
                          className="mt-4 text-white py-2.5 px-6 rounded-lg font-medium transition-all hover:shadow-md"
                          style={{ background: `linear-gradient(90deg, ${MIDNIGHT_BLUE} 0%, ${BLUE_GRAY} 100%)` }}
                        >
                          Create Admin
                        </button>
                      ...
                      >
                        <td className="px-4 py-4">
                          <div className="flex items-center">
                            <div 
                              ...
                              style={{ background: `linear-gradient(135deg, ${MIDNIGHT_BLUE} 0%, ${BLUE_GRAY} 100%)` }}
                            >
                            ...
                            <div className="ml-4">
                              ...
                              <div className="text-sm text-gray-500">{user.name || "No name provided"}</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-4 py-4">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {filteredModules.length > 0 ? (
                              filteredModules.map((mod, idx) => (
                                ...
                                >
                                  <span 
                                    className="text-xs px-2 py-1 rounded cursor-default font-medium"
                                    style={{ 
                                      background: `${DARK_BLUE}10`,
                                      color: DARK_BLUE
                                    }}
                                  >
                                  ...
                                  <div 
                                    className="absolute hidden group-hover:block z-10 bottom-full left-0 mb-2 text-white text-xs rounded px-2 py-1 whitespace-nowrap shadow-lg"
                        ...
                        <td className="px-4 py-4 text-right">
                          <button
                            ...
                            className="font-bold px-4 py-2 rounded-lg transition-colors border"
                            style={{ 
                              background: `${MIDNIGHT_BLUE}10`,
          ...
          {filteredUsers.length > 0 && (
            <div 
              className="px-2 py-2 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4 bg-gray-50"
            >
              <p className="text-sm text-gray-500">
                Showing <span className="font-bold">{indexOfFirstItem + 1}</span> to{' '}
                <span className="font-bold">{Math.min(indexOfLastItem, filteredUsers.length)}</span> of{' '}
                <span className="font-bold">{filteredUsers.length}</span> results
              </p>
        ...
        {modalType === "createAdmin" && (
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                <AdminCreate onClose={closeModal} onSuccess={handleAdminCreated} />
              </div>
            </div>
          </motion.div>
        )}
