      ...
      <div className="bg-white w-full max-w-2xl rounded-lg shadow-lg p-6 border border-gray-200">
        <div className="flex justify-between items-center mb-6 pb-3 border-b border-gray-200">
          <h3 className="text-xl font-bold text-gray-800">
            Manage Permissions for <span className="text-gray-700 font-semibold">{admin.email}</span>
          </h3>
          <button
            onClick={onClose}
        ...
        <div className="mt-7 pt-5 border-t border-gray-200">
          <div className="flex items-center mb-6">
            ...
            />
            <label htmlFor="delete-admin" className="ml-2 text-sm text-red-700 font-medium">
