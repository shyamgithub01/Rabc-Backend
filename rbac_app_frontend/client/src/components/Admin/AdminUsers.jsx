...
function AdminUsers() {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      // Filter only users created by this admin and sort by newest first
      const adminUsers = allUsers
        .filter(u => u.role === "user" && u.created_by === currentAdmin.id)
        .sort((a, b) => b.id - a.id);
  ...
  // Get permissions for Users module
  const userModulePermissions = (adminPermissions || []).find(
    (m) => m.module_name === "Users"
  )?.permissions || [];
  ...
  return (
    <div className="w-full pt-5 relative">
      ...
      {isLoading ? (
        ...
        <div 
          className="flex flex-col items-center justify-center h-64 bg-white rounded-2xl shadow-sm border mx-4 sm:mx-6 text-center"
          style={{ borderColor: BABY_BLUE }}
        >
          <div 
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-400" fill="none" viewBox="0 0 24 24" stroke={MIDNIGHT_BLUE}>
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
          </div>
          <h3 className="text-lg font-bold text-gray-700">Access Restricted</h3>
          <p className="mt-1 text-gray-500">You don't have permission to view users</p>
        </div>
      ) : (
        <div 
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-6 py-4 border-b border-gray-100">
            <h3 className="font-semibold text-gray-800 mb-4 sm:mb-0">User Accounts</h3>
          ...
          <div className="overflow-x-auto">
            ...
            >
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-3 font-medium text-gray-500 text-left text-xs uppercase tracking-wider">User</th>
                  <th className="px-6 py-3 font-medium text-gray-500 text-left text-xs uppercase tracking-wider">Role</th>
                  <th className="px-6 py-3 font-medium text-gray-500 text-left text-xs uppercase tracking-wider">Permissions</th>
                  <th className="px-6 py-3 font-medium text-gray-500 text-right text-xs uppercase tracking-wider">Actions</th>
                </tr>
              </thead>
              <tbody 
                  ...
                  <tr>
                    <td colSpan="4" className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center justify-center text-gray-500">
                        ...
                        <p className="mt-1 text-sm text-gray-400">Create your first user to get started</p>
                        {canAddUser && (
                          <button
                            onClick={openCreateModal}
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center">
                            ...
                            <div className="ml-3">
                              ...
                              <div className="text-xs text-gray-500">{user.name || "No name provided"}</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                              ...
                              filteredModules.map((mod, idx) => (
                                ...
                                >
                                  ...
                                  <div 
                                    ...
                                    style={{ backgroundColor: "rgba(65,114,159,0.9)" }}
                                  >
        ...
        {modalType === "createUser" && (
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                <UserCreate onClose={closeModal} onSuccess={handleUserCreated} />
              </div>
            </div>
          </motion.div>
        )}
