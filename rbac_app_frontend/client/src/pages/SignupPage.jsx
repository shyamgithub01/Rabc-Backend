...
function SignupPage() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      setResponseMsg(err.response?.data?.detail || "Signup failed. Please try again.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    ...
    <>
    <Navbar/>
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 flex flex-col justify-center p-4 sm:p-6">
      {/* Background elements */}
      <div className="absolute inset-0  overflow-hidden">
        ...
        <div className="absolute top-1/3 right-10 w-72 h-72 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
      ...
      <div className="relative z-10 max-w-md w-full mx-auto" ref={formRef}>
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl mt-25 font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-700">
            Create Account
          </h1>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-3 bg-white/50 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-base"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-10 py-3 bg-white/50 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-base"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
